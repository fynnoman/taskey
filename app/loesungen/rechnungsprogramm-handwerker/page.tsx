...
const data: LandingPageData = {
  ...
  painPoints: [
    { text: 'Rechnungen werden Wochen nach Auftragsende geschrieben – Geld kommt spät.' },
    { text: 'Positionen müssen manuell von Stundenzetteln und Lieferscheinen abgetippt werden.' },
    { text: 'Rechnungsfehler führen zu Kürzungen und Ärger mit Kunden.' },
    { text: 'Den Überblick über offene Rechnungen verlierst du regelmäßig.' },
  ],
  ...
  solutionSteps: [
    { title: 'Auftrag abschließen', description: 'Markiere den Auftrag als abgeschlossen – alle Stunden und Materialien sind erfasst.' },
    { title: 'Rechnung generieren', description: 'Taskey erstellt die Rechnung automatisch aus den Auftragsdaten.' },
    { title: 'Versenden & tracken', description: 'Per Mail versenden und den Zahlungseingang direkt in Taskey verfolgen.' },
  ],
  ctaText: 'Rechnungen automatisieren',
  featureHighlights: [
    { title: 'Automatische Rechnungen', description: 'Rechnungen werden aus Auftragsdaten automatisch befüllt.' },
    { title: 'Per Mail versenden', description: 'Rechnung als PDF direkt aus Taskey an den Kunden mailen.' },
    { title: 'Zahlungs-Tracking', description: 'Sieh auf einen Blick, welche Rechnungen bezahlt sind und welche offen.' },
    { title: 'Mahnwesen', description: 'Automatische Zahlungserinnerungen bei überfälligen Rechnungen.' },
    { title: 'Umsatzübersicht', description: 'Monatliche und jährliche Umsatzübersichten auf einen Blick.' },
    { title: 'GoBD-konform', description: 'Alle Rechnungen werden revisionssicher archiviert.' },
  ],
