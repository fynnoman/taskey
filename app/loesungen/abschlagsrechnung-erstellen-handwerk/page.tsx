...
const data: LandingPageData = {
  ...
  painPoints: [
    { icon: '🧮', text: 'Manuelles Berechnen von Abschlagssummen ist fehleranfällig und zeitraubend.' },
    { icon: '📂', text: 'Kein Überblick, welche Abschläge bereits bezahlt wurden.' },
    { icon: '⚠️', text: 'Schlussrechnung stimmt nicht mit den Abschlägen überein – Ärger mit dem Kunden.' },
    { icon: '💸', text: 'Liquiditätsengpässe, weil Abschlagsrechnungen zu spät gestellt werden.' },
  ],
  ...
  solutionSteps: [
    { icon: '📋', title: 'Auftragssumme hinterlegen', description: 'Gesamtauftragswert eingeben und Abschlagsintervalle festlegen.' },
    { icon: '🧾', title: 'Abschlag erstellen', description: 'Per Knopfdruck die nächste Abschlagsrechnung mit korrekter Nummerierung generieren.' },
    { icon: '✅', title: 'Schlussrechnung', description: 'Automatische Schlussrechnung mit Auflistung aller geleisteten Abschläge.' },
  ],
  ctaText: 'Jetzt Abschläge digitalisieren',
  featureHighlights: [
    { icon: '🔢', title: 'Automatische Nummerierung', description: 'Fortlaufende Abschlagsnummern werden automatisch vergeben.' },
    { icon: '📊', title: 'Zahlungsübersicht', description: 'Auf einen Blick sehen, welche Abschläge offen oder bezahlt sind.' },
    { icon: '🧾', title: 'Schlussrechnung', description: 'Automatisch generierte Schlussrechnung mit allen Abzügen.' },
    { icon: '💰', title: 'Liquiditätsplanung', description: 'Geplante Zahlungseingänge für bessere Finanzplanung.' },
    { icon: '📤', title: 'Direktversand', description: 'Abschlagsrechnungen per E-Mail direkt an den Kunden senden.' },
    { icon: '📁', title: 'Projektverknüpfung', description: 'Alle Rechnungen sind dem zugehörigen Projekt zugeordnet.' },
  ],
