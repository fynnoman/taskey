...
const data: LandingPageData = {
  ...
  painPoints: [
    { text: 'Handschriftliche Lieferscheine – unleserlich und unprofessionell.' },
    { text: 'Lieferscheine gehen auf dem Weg ins Büro verloren.' },
    { text: 'Keine Verknüpfung zwischen Lieferschein und Rechnung.' },
    { text: 'Lieferscheine nachträglich abtippen kostet Zeit.' },
  ],
  ...
  solutionSteps: [
    { title: 'Positionen erfassen', description: 'Material und Mengen für den Lieferschein eingeben.' },
    { title: 'Unterschrift einholen', description: 'Kunde unterschreibt digital auf dem Smartphone oder Tablet.' },
    { title: 'Automatisch zuordnen', description: 'Lieferschein wird automatisch dem Auftrag und der Rechnung zugeordnet.' },
  ],
  ctaText: 'Jetzt Lieferscheine digitalisieren',
  featureHighlights: [
    { title: 'Professionelles Format', description: 'Lieferscheine im eigenen Firmendesign mit allen Pflichtangaben.' },
    { title: 'Digitale Unterschrift', description: 'Kunden unterschreiben direkt auf dem Gerät.' },
    { title: 'Auftragverknüpfung', description: 'Jeder Lieferschein ist mit dem zugehörigen Auftrag verbunden.' },
    { title: 'Sofortversand', description: 'Lieferschein direkt per E-Mail an den Kunden senden.' },
    { title: 'Rechnungsgrundlage', description: 'Aus Lieferscheinen direkt Rechnungen erstellen.' },
    { title: 'Digitales Archiv', description: 'Alle Lieferscheine revisionssicher digital archiviert.' },
  ],
