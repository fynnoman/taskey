...
const data: LandingPageData = {
  ...
  relatedLinks: [
    { href: '/loesungen/leistungsnachweis-gebäudereinigung', label: 'Leistungsnachweise', description: 'Erbrachte Reinigungsleistungen dokumentieren – als Basis für die Rechnung.' },
