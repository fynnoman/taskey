...
const data: LandingPageData = {
  ...
  painPoints: [
    { text: 'Handschriftliche Protokolle sind unleserlich und unvollständig.' },
    { text: 'Protokolle gehen verloren – keine Nachweise bei Streitigkeiten.' },
    { text: 'Zustand vor Reinigungsbeginn wird nicht dokumentiert.' },
    { text: 'Bei Schäden fehlen Beweise für den Ausgangszustand.' },
  ],
  ...
  solutionSteps: [
    { title: 'Protokoll erstellen', description: 'Räume, Zustand und Besonderheiten systematisch erfassen.' },
    { title: 'Fotos hinzufügen', description: 'Den Zustand mit Fotos dokumentieren – als Beweis.' },
    { title: 'Digital unterschreiben', description: 'Beide Parteien unterschreiben direkt auf dem Tablet oder Smartphone.' },
  ],
  ctaText: 'Jetzt Übergaben digital dokumentieren',
  featureHighlights: [
    { title: 'Standardisierte Vorlagen', description: 'Professionelle Protokollvorlagen für verschiedene Übergabetypen.' },
    { title: 'Fotodokumentation', description: 'Zustand jedes Raums mit Fotos festhalten.' },
    { title: 'Digitale Unterschrift', description: 'Rechtssichere digitale Unterschriften beider Parteien.' },
    { title: 'Sofort verfügbar', description: 'Protokoll sofort als PDF per E-Mail an alle Beteiligten.' },
    { title: 'Archivierung', description: 'Alle Protokolle digital archiviert und jederzeit abrufbar.' },
    { title: 'Vergleichbar', description: 'Übergabe- und Rücknahmeprotokoll vergleichen.' },
  ],
