...
export const metadata: Metadata = {
  ...
  description: 'Reinigungsmittel und Material digital verwalten: Bestaende, Verbrauch, Nachbestellungen. Für Gebäudereinigungsunternehmen im DACH-Raum.',
...
const data: LandingPageData = {
  ...
  subheadline: 'Wer verbraucht was, wo und wie viel? Behalte den Überblick über deine Reinigungsmittel.',
  ...
  painPoints: [
    ...
    { text: 'Reinigungskräfte bestellen Material ohne Abstimmung – Kosten explodieren.' },
  ...
  solutionDescription: 'Taskey verknuepft Materialverbrauch mit Objekten und gibt dir volle Transparenz über Kosten.',
  solutionSteps: [
    { title: 'Materialstamm anlegen', description: 'Hinterlege alle Reinigungsmittel mit Preisen und Lieferanten.' },
    { title: 'Verbrauch erfassen', description: 'Reinigungskräfte melden Materialverbrauch direkt in der App pro Objekt.' },
  ...
  featureHighlights: [
    ...
    { title: 'Bestandsübersicht', description: 'Aktuelle Lagerbestaende in Echtzeit.' },
