...
export const metadata: Metadata = {
  ...
  description: 'Digitale Krankmeldung fuer Reinigungsunternehmen: Ausfaelle melden, Vertretung finden, Einsatzplan anpassen – alles in einer App.',
...
const data: LandingPageData = {
  ...
  subheadline: 'Mitarbeiter meldet sich krank? In Sekunden weisst du Bescheid und findest Ersatz.',
  heroDescription: 'In der Gebaeudereinigung fuehrt jeder Ausfall sofort zu Problemen beim Kunden. Taskey macht Krankmeldungen digital und hilft dir, blitzschnell Vertretungen zu organisieren.',
  painPoints: [
    { text: 'Krankmeldungen kommen per Anruf um 5 Uhr morgens – Chaos beim Disponieren.' },
    { text: 'Niemand weiss, welcher Mitarbeiter als Vertretung verfuegbar ist.' },
    { text: 'Objekte bleiben ungereinigt, weil Ausfaelle zu spaet bekannt werden.' },
    { text: 'Keine Dokumentation, wer wann krank war – fuer die Lohnabrechnung ein Problem.' },
  ],
  ...
  solutionSteps: [
    ...
    { title: 'Verfuegbare Vertretungen sehen', description: 'Taskey zeigt sofort, welche Mitarbeiter frei und qualifiziert sind.' },
  ...
  featureHighlights: [
    ...
    { title: 'Vertretungssuche', description: 'Verfuegbare und qualifizierte Mitarbeiter sofort sichtbar.' },
  ...
  relatedLinks: [
    ...
    { href: '/loesungen/einsatzplanung-gebaeudereinigung', label: 'Einsatzplanung', description: 'Einsaetze intelligent koordinieren.' },
  ],
};
