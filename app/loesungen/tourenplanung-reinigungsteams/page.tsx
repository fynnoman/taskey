...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.taskeyapp.com/loesungen/tourenplanung-reinigungsteams' },
};
...
const data: LandingPageData = {
  ...
  painPoints: [
    { text: 'Reinigungsteams fahren kreuz und quer – unnötige Kilometer jeden Tag.' },
    { text: 'Spritkosten und Fahrzeiten fressen die Marge.' },
    { text: 'Tourenplanung auf Papier ist unflexibel bei kurzfristigen Änderungen.' },
    { text: 'Teams kommen zu spät, weil die Reihenfolge nicht optimiert ist.' },
  ],
  ...
  solutionSteps: [
    { title: 'Objekte auf Karte', description: 'Sieh alle Objekte auf einer Karte und plane die Route visuell.' },
    { title: 'Route optimieren', description: 'Taskey schlägt die optimale Reihenfolge vor – minimale Fahrzeit.' },
    { title: 'Tour aufs Handy', description: 'Das Team erhält die Tour mit Navigation direkt auf dem Smartphone.' },
  ],
  ctaText: 'Touren optimieren',
  featureHighlights: [
    { title: 'Kartenansicht', description: 'Alle Objekte auf einer interaktiven Karte.' },
    { title: 'Routenoptimierung', description: 'Automatische Berechnung der kürzesten Route.' },
    { title: 'Mobile Navigation', description: 'Teams navigieren direkt über die App zum nächsten Objekt.' },
    { title: 'Flexible Umplanung', description: 'Bei Ausfall schnell umplanen – alle werden informiert.' },
    { title: 'Fahrzeit-Reports', description: 'Auswertung der Fahrzeiten und Strecken pro Team.' },
    { title: 'Kosten senken', description: 'Weniger Fahrzeit = weniger Sprit = mehr Marge.' },
  ],
