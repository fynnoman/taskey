...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.taskeyapp.com/loesungen/schichtplanung-reinigungsunternehmen' },
};
...
const data: LandingPageData = {
  ...
  painPoints: [
    { text: 'Schichtpläne in Excel sind unübersichtlich und fehleranfällig.' },
    { text: 'Bei Krankheit musst du alle abtelefonieren, um Ersatz zu finden.' },
    { text: 'Änderungen erreichen die Reinigungskräfte nicht rechtzeitig.' },
    { text: 'Doppelbelegungen und vergessene Objekte kosten Kunden.' },
  ],
  ...
  solutionSteps: [
    { title: 'Schichten planen', description: 'Erstelle Schichtpläne per Drag & Drop – visuell, übersichtlich, schnell.' },
    { title: 'Teams zuweisen', description: 'Weise Reinigungskräfte Objekten und Schichten zu – mit Qualifikationsabgleich.' },
    { title: 'Sofort informiert', description: 'Jede Änderung wird sofort per Push-Nachricht an betroffene Mitarbeiter gesendet.' },
  ],
  ctaText: 'Schichtplanung starten',
  featureHighlights: [
    { title: 'Drag & Drop Planung', description: 'Schichten visuell erstellen und anpassen – intuitiv und schnell.' },
    { title: 'Konflikterkennung', description: 'Automatische Warnung bei Doppelbelegungen oder Überlastung.' },
    { title: 'Mobile Einsicht', description: 'Reinigungskräfte sehen ihren Schichtplan jederzeit auf dem Handy.' },
    { title: 'Vertretungsmanagement', description: 'Bei Ausfall schnell Ersatz finden und zuweisen.' },
    { title: 'Objekt-basiert', description: 'Plane nach Objekten, nicht nur nach Mitarbeitern.' },
    { title: 'Auslastungsübersicht', description: 'Sieh auf einen Blick, welche Mitarbeiter über- oder unterlastet sind.' },
  ],
