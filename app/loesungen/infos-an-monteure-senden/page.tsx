...
const data: LandingPageData = {
  ...
  painPoints: [
    { text: 'Jeden Monteur einzeln anrufen bei Änderungen – dauert ewig.' },
    { text: 'WhatsApp-Nachrichten gehen in der Flut unter.' },
    { text: 'Keine Bestätigung, ob die Info gelesen wurde.' },
    { text: 'Wichtige Dokumente können nicht einfach geteilt werden.' },
  ],
  ...
  solutionSteps: [
    { title: 'Info erstellen', description: 'Nachricht verfassen und relevante Dokumente oder Fotos anhängen.' },
    { title: 'Empfänger wählen', description: 'An einzelne Monteure, Teams oder alle senden.' },
    { title: 'Lesebestätigung', description: 'Sehen, wer die Info gelesen hat und wer nicht.' },
  ],
  ctaText: 'Jetzt Infos effizienter verteilen',
  featureHighlights: [
    { title: 'Push-Benachrichtigung', description: 'Wichtige Infos erscheinen sofort auf dem Monteur-Smartphone.' },
    { title: 'Lesebestätigung', description: 'Nachweisbar, dass jeder Monteur die Info erhalten und gelesen hat.' },
    { title: 'Anhänge', description: 'Pläne, Fotos und Dokumente direkt mitsenden.' },
    { title: 'Gruppenverteilung', description: 'Infos an einzelne Personen, Teams oder alle auf einmal.' },
    { title: 'Projektbezogen', description: 'Infos dem richtigen Projekt zuordnen.' },
    { title: 'Nachrichtenarchiv', description: 'Alle gesendeten Infos dokumentiert und abrufbar.' },
  ],
