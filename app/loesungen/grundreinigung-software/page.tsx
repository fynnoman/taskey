...
export const metadata: Metadata = {
  title: 'Grundreinigung Software – Auftraege planen & dokumentieren | Taskey',
  description: 'Software fuer Grundreinigung: Bodenreinigung, Steinbodensanierung, Teppichgrundreinigung – Auftraege planen, kalkulieren und dokumentieren. Jetzt testen!',
...
const data: LandingPageData = {
  ...
  solutionSteps: [
    ...
    { title: 'Team einplanen', description: 'Weise qualifizierte Reinigungskraefte und Spezialgeraete dem Auftrag zu.' },
  ...
  featureHighlights: [
    ...
    { title: 'Materialplanung', description: 'Reinigungsmittel und Geraete pro Auftrag planen.' },
    { title: 'Vorher/Nachher-Fotos', description: 'Fotodokumentation mit Zeitstempel fuer den Kunden.' },
  ...
  relatedLinks: [
    ...
    { href: '/loesungen/inventar-verwalten-reinigungsfirma', label: 'Inventar Reinigung', description: 'Reinigungsmittel und Geraete verwalten.' },
