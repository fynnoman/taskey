...
export const metadata: Metadata = {
  ...
  description: 'Vertragsverwaltung fuer Reinigungsunternehmen: Laufzeiten, Kuendigungsfristen, Leistungsumfang und Preise zentral verwalten. Jetzt testen!',
...
const data: LandingPageData = {
  ...
  subheadline: 'Laufzeiten, Kuendigungsfristen, SLAs – alle Vertraege digital im Griff.',
  heroDescription: 'Reinigungsvertraege sind das Rueckgrat deines Umsatzes. Taskey hilft dir, Laufzeiten zu ueberwachen, Fristen einzuhalten und Vertragsinhalte mit Leistungen abzugleichen.',
  painPoints: [
    { text: 'Kuendigungsfristen werden verpasst – Vertraege laufen ungewollt weiter oder enden.' },
    ...
    { text: 'Kein Ueberblick, welche Leistungen vertraglich vereinbart sind.' },
  ],
  ...
  solutionSteps: [
    { title: 'Vertraege erfassen', description: 'Lege Vertraege an mit Laufzeit, Kuendigungsfrist, Leistungsumfang und Preis.' },
    { title: 'Erinnerungen setzen', description: 'Automatische Erinnerungen vor Kuendigungsfristen oder Preisanpassungen.' },
  ...
  featureHighlights: [
    { title: 'Fristen-Alarm', description: 'Automatische Erinnerung vor Kuendigungsfristen.' },
