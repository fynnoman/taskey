...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.taskeyapp.com/loesungen/zeiterfassung-app-aussendienst' },
};
...
const data: LandingPageData = {
  ...
  painPoints: [
    { text: 'Außendienstler rufen im Büro an, um ihre Zeiten durchzugeben.' },
    { text: 'Zeiten werden abends aus dem Gedächtnis rekonstruiert.' },
    { text: 'Bürokraft tippt handschriftliche Zettel in Excel ab.' },
    { text: 'Fehlerquote hoch – niemand weiß, ob Zeiten stimmen.' },
  ],
  ...
  solutionSteps: [
    { title: 'App starten, einstempeln', description: 'Ein Tap auf dem Smartphone – Arbeitszeit läuft. GPS-Position wird automatisch erfasst.' },
    { title: 'Einsatz dokumentieren', description: 'Fotos, Notizen und Material direkt im Einsatz erfassen – kein Nachdokumentieren.' },
    { title: 'Automatisch im Büro', description: 'Alle Daten sind sofort im Büro verfügbar – kein Abtippen, kein Nachfragen.' },
  ],
  ctaText: 'Außendienst-App testen',
  featureHighlights: [
    { title: 'Intuitive App', description: 'So einfach wie WhatsApp – keine Schulung nötig.' },
    { title: 'GPS-Protokoll', description: 'Wo war der Mitarbeiter? GPS-Nachweis für jeden Einsatz.' },
    { title: 'Fotodokumentation', description: 'Fotos mit automatischem Zeitstempel und GPS-Tag.' },
    { title: 'Offline-Modus', description: 'Funktioniert auch im Keller oder in Funklöchern.' },
    { title: 'Push-Nachrichten', description: 'Neue Aufträge und Änderungen direkt aufs Handy.' },
    { title: 'Echtzeit-Dashboards', description: 'Im Büro siehst du live, wer wo im Einsatz ist.' },
  ],
