...
const data: LandingPageData = {
  ...
  painPoints: [
    { text: 'Projektdokumente in verschiedenen Ordnern, E-Mails und Schubladen verteilt.' },
    { text: 'Stundenlange Suche nach einem bestimmten Dokument.' },
    { text: 'Bei Streitigkeiten fehlen wichtige Nachweise und Protokolle.' },
    { text: 'Bauakten werden erst nach Projektende zusammengestellt – wenn überhaupt.' },
  ],
  ...
  solutionSteps: [
    { title: 'Bauakte anlegen', description: 'Für jedes Projekt automatisch eine digitale Bauakte erstellen.' },
    { title: 'Dokumente zuordnen', description: 'Alle Dokumente, Fotos und Protokolle werden automatisch der Akte zugeordnet.' },
    { title: 'Jederzeit abrufbar', description: 'Die komplette Bauakte jederzeit einsehen, teilen oder exportieren.' },
  ],
  ctaText: 'Jetzt Bauakten digitalisieren',
  featureHighlights: [
    { title: 'Automatische Zuordnung', description: 'Alle projektbezogenen Dokumente werden automatisch gesammelt.' },
    { title: 'Foto-Dokumentation', description: 'Alle Baustellenfotos chronologisch in der Akte gespeichert.' },
    { title: 'Protokolle', description: 'Baubesprechungen, Abnahmen und Mängelprotokolle integriert.' },
    { title: 'Schnelle Suche', description: 'Jedes Dokument in Sekunden finden – per Stichwortsuche.' },
    { title: 'Export', description: 'Komplette Bauakte als PDF oder ZIP exportieren.' },
    { title: 'Revisionssicher', description: 'Alle Dokumente unveränderlich archiviert – für rechtliche Sicherheit.' },
  ],
