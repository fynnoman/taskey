...
const data: LandingPageData = {
  ...
  painPoints: [
    { text: 'Engpässe bei Personal und Maschinen führen zu Projektverzögerungen.' },
    { text: 'Keine Übersicht über die aktuelle Auslastung aller Ressourcen.' },
    { text: 'Teure Maschinen stehen ungenutzt herum, während sie anderswo gebraucht werden.' },
    { text: 'Ressourcenplanung per Whiteboard funktioniert nicht mehr ab 5 Baustellen.' },
  ],
  solutionTitle: 'Alle Ressourcen im Blick',
  solutionDescription: 'Taskey zeigt Ihnen die Auslastung aller Ressourcen in Echtzeit.',
  solutionSteps: [
    { title: 'Auslastung prüfen', description: 'Sehen Sie sofort, welche Ressourcen verfügbar oder überlastet sind.' },
    { title: 'Optimal verteilen', description: 'Weisen Sie Personal, Maschinen und Material den Projekten zu.' },
    { title: 'Engpässe vermeiden', description: 'Frühwarnsystem bei drohenden Ressourcenengpässen.' },
  ],
  ctaText: 'Jetzt Ressourcen optimal planen',
  featureHighlights: [
    { title: 'Personalplanung', description: 'Mitarbeiter nach Qualifikation und Verfügbarkeit einplanen.' },
    { title: 'Maschinenplanung', description: 'Maschinen und Geräte den Baustellen zuordnen.' },
    { title: 'Materialplanung', description: 'Materialbedarf pro Projekt berechnen und Bestellungen planen.' },
    { title: 'Auslastungsübersicht', description: 'Kapazitäten über alle Projekte hinweg visualisieren.' },
    { title: 'Engpass-Warnung', description: 'Automatisch alarmiert werden bei Ressourcenkonflikten.' },
    { title: 'Prognose', description: 'Zukünftigen Ressourcenbedarf basierend auf geplanten Projekten vorhersagen.' },
  ],
