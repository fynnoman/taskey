...
export const metadata: Metadata = {
  ...
  description: 'Software fuer PV-Reinigung: Auftraege planen, NFC-Leistungsnachweise, Qualitaetskontrolle. Ideal fuer Reinigungsunternehmen mit Solarpanel-Reinigung.',
...
const data: LandingPageData = {
  ...
  heroDescription: 'Die Reinigung von Solaranlagen erfordert praezise Planung und lueckenlose Dokumentation. Taskey hilft dir, PV-Reinigungsauftraege effizient zu verwalten.',
  painPoints: [
    { text: 'PV-Reinigungsauftraege sind schwer zu planen – saisonale Spitzen ueberfordern.' },
  ...
  solutionTitle: 'PV-Reinigung. Lueckenlos digital.',
  ...
  solutionSteps: [
    ...
    { title: 'Teams zuweisen & planen', description: 'Weise Reinigungsteams zu und plane Einsaetze nach Wetterlage und Saison.' },
  ...
  featureHighlights: [
    ...
    { title: 'Leistungsnachweis', description: 'Digitale Nachweise fuer Betreiber und Versicherungen.' },
  ...
  closingText: 'Teste Taskey 14 Tage kostenlos und manage deine PV-Reinigungsauftraege effizient.',
  relatedLinks: [
    ...
    { href: '/loesungen/qualitaetskontrolle-gebaeudereinigung', label: 'Qualitaetskontrolle', description: 'Reinigungsqualitaet pruefen und dokumentieren.' },
