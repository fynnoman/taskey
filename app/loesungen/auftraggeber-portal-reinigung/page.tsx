...
export const metadata: Metadata = {
  title: 'Auftraggeber-Portal Reinigung – Transparenz fuer deine Kunden | Taskey',
  description: 'Auftraggeber-Portal fuer Gebaeudereinigung: Kunden sehen Reinigungsnachweise, Leistungsberichte und Qualitaetsdaten in Echtzeit. Jetzt testen!',
...
const data: LandingPageData = {
  ...
  heroDescription: 'Auftraggeber wollen wissen, ob und wann gereinigt wurde. Mit dem Taskey Auftraggeber-Portal gibst du ihnen volle Transparenz – ohne Mehraufwand fuer dich.',
  painPoints: [
    ...
    { text: 'Kein professionelles Reporting fuer Auftraggeber.' },
  ],
  solutionTitle: 'Dein Kunde. Dein Portal. Volle Transparenz.',
  solutionDescription: 'Auftraggeber loggen sich ein und sehen alle Reinigungsnachweise, Berichte und Qualitaetsdaten.',
  solutionSteps: [
    { title: 'Portal einrichten', description: 'Erstelle fuer jeden Auftraggeber einen eigenen Zugang in wenigen Klicks.' },
    { title: 'Automatische Nachweise', description: 'NFC-Scans, Checklisten und Fotos werden automatisch im Portal sichtbar.' },
    { title: 'Feedback einholen', description: 'Auftraggeber koennen direkt im Portal Feedback geben oder Sonderwuensche melden.' },
  ],
  ...
  relatedLinks: [
    ...
    { href: '/loesungen/sla-tracking-reinigungsfirma', label: 'SLA-Tracking', description: 'Service-Level-Agreements ueberwachen.' },
    { href: '/loesungen/leistungsnachweis-gebaeudereinigung', label: 'Leistungsnachweis', description: 'Digitale Leistungsnachweise.' },
  ],
};
