...
export const metadata: Metadata = {
  title: 'Fassadenreinigung Software – Auftraege planen & dokumentieren | Taskey',
  description: 'Software fuer Fassadenreinigung: Klinker, Naturstein, Putz, Metall – Auftraege planen, Sicherheit dokumentieren, Nachweise erstellen. Jetzt testen!',
...
const data: LandingPageData = {
  ...
  heroDescription: 'Fassadenreinigung erfordert Sicherheitsplanung und exakte Dokumentation. Taskey verwaltet Auftraege, Sicherheitsprotokolle und Leistungsnachweise.',
  painPoints: [
    { text: 'Sicherheitsvorschriften fuer Hoehenarbeiten muessen dokumentiert werden.' },
  ...
  featureHighlights: [
    { title: 'Sicherheitsprotokolle', description: 'Digitale Sicherheitschecklisten fuer Hoehenarbeiten.' },
    ...
    { title: 'Fotodokumentation', description: 'Vorher/Nachher-Vergleich fuer den Auftraggeber.' },
    { title: 'Geraeteplanung', description: 'Hubbuehnen und Spezialgeraete Auftraegen zuweisen.' },
  ],
  ...
  relatedLinks: [
    ...
    { href: '/loesungen/inventar-verwalten-reinigungsfirma', label: 'Inventar Reinigung', description: 'Geraete und Reinigungsmittel verwalten.' },
  ],
};
