...
export const metadata: Metadata = {
  ...
  description: 'Software für Schulreinigung: Reinigungspläne, Ferienplanung, NFC-Nachweise, Qualitätskontrolle. Für Reinigungsunternehmen mit Schulobjekten.',
...
const data: LandingPageData = {
  ...
  painPoints: [
    ...
    { text: 'Schultraeger fordern Nachweise über erbrachte Reinigungsleistungen.' },
    { text: 'Verschiedene Raumtypen (Klassenzimmer, WC, Mensa) brauchen unterschiedliche Standards.' },
  ],
  solutionTitle: 'Schulreinigung. Effizient geplant. Lückenlos nachgewiesen.',
  ...
  solutionSteps: [
    ...
    { title: 'Nachweise für Schultraeger', description: 'NFC-Scans und Checklisten als digitaler Nachweis für den Auftraggeber.' },
  ],
  ...
  featureHighlights: [
    ...
    { title: 'NFC pro Raum', description: 'NFC-Tags in jedem Raum für exakte Nachweise.' },
  ...
  relatedLinks: [
    ...
    { href: '/loesungen/auftraggeber-portal-reinigung', label: 'Kundenportal', description: 'Portal für Schultraeger.' },
  ],
};
