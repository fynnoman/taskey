...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.taskeyapp.com/loesungen/zeiterfassung-handwerk' },
};
...
const data: LandingPageData = {
  ...
  painPoints: [
    { text: 'Stundenzettel kommen erst Freitag – halb unleserlich, halb vergessen.' },
    { text: 'Überstunden werden falsch berechnet, Mitarbeiter beschweren sich.' },
    { text: 'Excel-Tabellen kosten dich Stunden – jede Woche aufs Neue.' },
    { text: 'Bei einer Prüfung fehlen lückenlose Arbeitszeitnachweise.' },
  ],
  ...
  solutionSteps: [
    { title: 'App starten, einstempeln', description: 'Ein Tap auf dem Handy reicht. Oder NFC-Tag an der Baustelle scannen. GPS-Position wird automatisch erfasst.' },
    { title: 'Alles automatisch dokumentiert', description: 'Stunden, Pausen, Überstunden – alles wird automatisch berechnet und ist sofort abrufbar.' },
    { title: 'Export zum Steuerberater', description: 'Monatliche Stundenübersichten als PDF oder CSV. Direkt weiterleiten, ohne Nacharbeit.' },
  ],
  ctaText: '14 Tage kostenlos testen',
  featureHighlights: [
    { title: 'GPS-Zeitstempel', description: 'Jeder Stempelvorgang wird mit GPS-Position dokumentiert – lückenlos und rechtssicher.' },
    { title: 'NFC-Stempeluhr', description: 'NFC-Tags an der Baustelle = kontaktloses Einstempeln ohne App-Eingabe.' },
    { title: 'Automatische Pausenberechnung', description: 'Gesetzliche Pausen werden automatisch berücksichtigt und korrekt abgezogen.' },
    { title: 'Überstunden-Übersicht', description: 'Alle Überstunden auf einen Blick – pro Mitarbeiter, pro Woche, pro Monat.' },
    { title: 'DSGVO-konform', description: 'Alle Daten auf deutschen Servern. Datenschutz nach höchsten Standards.' },
    { title: 'Steuerberater-Export', description: 'Fertige Reports für Ihren Steuerberater. Kein manuelles Abtippen mehr.' },
  ],
