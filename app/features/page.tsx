  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="py-20">
        ...
        <div className="mx-4 sm:mx-6 lg:mx-8 mt-16 mb-0 relative rounded-2xl overflow-hidden bg-gradient-to-br from-emerald-900 via-teal-900 to-gray-900 border border-white/10">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 px-8 py-7">
            <div className="flex-shrink-0 w-14 h-14 rounded-2xl bg-emerald-400/20 border border-emerald-400/30 flex items-center justify-center">
              <svg className="w-7 h-7 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-xs font-black text-emerald-400 uppercase tracking-widest mb-1.5">Add-on · Für alle Pakete · 11,89 € / Monat</p>
              <h3 className="text-xl md:text-2xl font-black text-white mb-1">DATEV & Lexware direkt angebunden.</h3>
              <p className="text-gray-400 text-sm">Zeiterfassungen, Belege und Lohndaten fließen automatisch in Ihr Buchhaltungssystem. Kein manueller Export, keine doppelte Arbeit.</p>
            </div>
            <div className="flex-shrink-0">
