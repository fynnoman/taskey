        ...
        {activeModel === "handwerk" ? (
          <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto mb-12">
            ...
            <div className="rounded-2xl border border-gray-200 p-8 text-center">
              ...
              <a href="https://signup.taskeyapp.com" className="block w-full py-3 bg-gray-900 text-white font-semibold rounded-xl hover:bg-gray-800 transition-colors text-center">
            ...
            <div className="rounded-2xl border-2 border-blue-900 p-8 text-center shadow-md">
              ...
              <a href="https://signup.taskeyapp.com" className="block w-full py-3 bg-blue-900 text-white font-semibold rounded-xl hover:bg-blue-800 transition-colors text-center">
