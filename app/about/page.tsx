              ...
              {[1, 2].map((i) => (
                <div key={i} className="text-center">
                  <div className="w-48 h-48 rounded-full mx-auto mb-4 overflow-hidden relative">
                    <Image src={i === 1 ? "/ACCD988C-E7FD-4CAE-9A87-E4452122FD80_1_201_a.jpeg" : "/6E606D3A-82B0-441E-91A5-9B811796FE2B_1_201_a.jpeg"} alt={i === 1 ? "Fynn-Luca Schulz" : "Julian Stosse"} fill className="object-cover" sizes="192px" />
                  </div>
