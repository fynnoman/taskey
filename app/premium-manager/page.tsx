  ...
  return (
    <>
      ...
      <section className="relative min-h-screen">
        ...
        {/* Content Layer */}
        <div className="relative z-10 min-h-screen py-20 flex items-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="max-w-4xl">
              ...
              >
                ...
                <h1 
                  ref={headingRef}
                  className="relative text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-black leading-[0.95] mb-8"
                  style={{
                ...
                <p className="text-xl md:text-2xl lg:text-3xl text-gray-400 mb-10 max-w-2xl">
                  Eine dedizierte Person, die sich zu 100% um Ihr Unternehmen kümmert
                </p>

                <button
                  onClick={() => setIsManagerModalOpen(true)}
                  className="inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-black text-xl rounded-xl hover:from-cyan-400 hover:to-blue-500 transition-all duration-300 shadow-2xl hover:shadow-cyan-500/50"
                >
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-500/30 rounded-xl p-6">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">Exklusiv für Sie</h3>
              ...
              <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-500/30 rounded-xl p-6">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">Sofortige Reaktion</h3>
                <p className="text-gray-400">
              ...
              <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-500/30 rounded-xl p-6">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">Proaktive Optimierung</h3>
                <p className="text-gray-400">
              ...
              <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-500/30 rounded-xl p-6">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">Vor-Ort Service</h3>
                <p className="text-gray-400">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6 max-w-5xl mx-auto">
            {[
              ...
              <div key={index} className="bg-gradient-to-r from-gray-800 to-gray-850 border border-gray-700 rounded-xl p-6 hover:border-cyan-400/50 transition-all duration-300">
      ...
      <section className="py-20 bg-gradient-to-b from-gray-900 to-gray-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 border-2 border-cyan-500/30 rounded-3xl p-10 md:p-14 text-center">
              ...
              <div className="grid md:grid-cols-3 gap-6 text-left">
                <div className="bg-gray-800/50 rounded-xl p-6">
                  ...
                  <h4 className="text-lg font-bold text-white mb-2">Wachstumsorientiert</h4>
                  <p className="text-gray-400 text-sm">Sie möchten skalieren und brauchen einen Partner, der mit Ihnen wächst.</p>
                </div>
                ...
                <div className="bg-gray-800/50 rounded-xl p-6">
                  ...
                  <h4 className="text-lg font-bold text-white mb-2">Zeitsparend</h4>
                  <p className="text-gray-400 text-sm">Zeit ist Ihr wertvollstes Gut – Sie möchten sich aufs Kerngeschäft konzentrieren.</p>
                </div>
                ...
                <div className="bg-gray-800/50 rounded-xl p-6">
                  ...
                  <h4 className="text-lg font-bold text-white mb-2">Premium-Service</h4>
                  <p className="text-gray-400 text-sm">Sie erwarten erstklassigen Support und individuelle Betreuung auf höchstem Niveau.</p>
                </div>
              </div>
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-gradient-to-br from-gray-800 to-gray-850 border border-gray-700 rounded-2xl p-8 md:p-12 mb-8">
              <h3 className="text-3xl font-bold text-white mb-6 text-center">Durchschnittliche Zeitersparnis: 50 Stunden/Monat</h3>
              
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <div>
                  <h4 className="text-xl font-bold text-cyan-400 mb-4">Ohne Manager:</h4>
                  <ul className="space-y-3 text-gray-400">
                    <li className="flex items-start gap-2">
                      <span className="text-red-400 font-bold">✗</span>
                      <span>Standard-Support mit Wartezeiten</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-400 font-bold">✗</span>
                      <span>Selbst durch Dokumentation wühlen</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-400 font-bold">✗</span>
                      <span>Trial & Error bei neuen Features</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-400 font-bold">✗</span>
                      <span>Ineffiziente Prozesse bleiben unentdeckt</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-400 font-bold">✗</span>
                      <span>Mitarbeiter-Schulungen selbst durchführen</span>
                    </li>
                  </ul>
                </div>

                <div>
                  <h4 className="text-xl font-bold text-cyan-400 mb-4">Mit Manager:</h4>
                  <ul className="space-y-3 text-gray-400">
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 font-bold">✓</span>
                      <span>Sofortige Antworten per Direktkontakt</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 font-bold">✓</span>
                      <span>Proaktive Einführung in neue Features</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 font-bold">✓</span>
                      <span>Optimale Workflows von Anfang an</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 font-bold">✓</span>
                      <span>Kontinuierliche Prozessoptimierung</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 font-bold">✓</span>
                      <span>Manager übernimmt alle Schulungen</span>
                    </li>
                  </ul>
                </div>
              </div>
      ...
      {/* Preise & CTA */}
      <section className="py-20 bg-gradient-to-br from-gray-950 via-slate-900 to-gray-950">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6">
            ...
            <span className="block bg-gradient-to-r from-cyan-400 via-blue-400 to-cyan-400 bg-clip-text text-transparent mt-2">
              persönlichen Manager
            </span>
          </h2>

          <div className="bg-gradient-to-br from-gray-900 to-gray-800 border-2 border-cyan-500/30 rounded-3xl p-8 md:p-12 mb-12">
            <div className="flex flex-col md:flex-row md:items-center md:justify-center gap-4 mb-8">
              <div className="flex items-baseline gap-3 justify-center">
                <span className="text-6xl md:text-7xl font-black text-white">239€</span>
                <span className="text-gray-400 text-2xl">/ Woche</span>
              </div>
            </div>

            <p className="text-cyan-400 font-semibold mb-2">zzgl. MwSt. | Jederzeit kündbar</p>
            <p className="text-gray-400 mb-8">Zubuchbar zu jedem Taskey-Paket</p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
              <button
                onClick={() => setIsManagerModalOpen(true)}
                className="group relative px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-black text-lg rounded-xl hover:from-cyan-400 hover:to-blue-500 transition-all duration-300 shadow-2xl hover:shadow-cyan-500/50 overflow-hidden"
              >
              ...
              <a
                ...
                className="px-8 py-4 bg-gray-800 border-2 border-gray-700 text-white font-bold text-lg rounded-xl hover:border-gray-600 hover:bg-gray-750 transition-all duration-300"
              >
                +49 151 684 88999
              </a>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 text-left">
              <div className="flex items-start gap-2">
                ...
                <span className="text-gray-400 text-sm">Exklusiver Direktkontakt</span>
              </div>
              <div className="flex items-start gap-2">
                <svg className="w-5 h-5 text-cyan-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-400 text-sm">24/7 Priority Support</span>
              </div>
              <div className="flex items-start gap-2">
                <svg className="w-5 h-5 text-cyan-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-400 text-sm">Proaktive Optimierung</span>
              </div>
              <div className="flex items-start gap-2">
                <svg className="w-5 h-5 text-cyan-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-400 text-sm">Persönliche Schulungen</span>
              </div>
              <div className="flex items-start gap-2">
                <svg className="w-5 h-5 text-cyan-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-400 text-sm">Vor-Ort Service</span>
              </div>
            </div>
          </div>
