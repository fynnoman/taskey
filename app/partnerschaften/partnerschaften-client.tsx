...
export default function PartnerschaftenClient() {
  ...
  const inputCls =
    'w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-cyan-400/50 focus:ring-2 focus:ring-cyan-400/20 outline-none transition-all text-white placeholder-white/30';
    ...
    <main className="relative bg-gradient-to-b from-gray-950 via-[#0a1628] to-gray-950 text-white min-h-screen overflow-hidden">
      ...
      <section className="relative pt-32 md:pt-40 pb-20 md:pb-28">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-2xl text-white/80 font-bold mb-4 max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a
                href="#modelle"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 border border-white/20 text-white text-base font-bold rounded-full hover:bg-white/10 transition-colors"
              >
                {t('partner.hero.cta2')}
              </a>
            </div>
      ...
      <section className="relative py-20 md:py-28">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md mb-8">
      ...
      <section className="relative py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <p className="text-[10px] sm:text-xs font-black text-cyan-300 uppercase tracking-[0.3em] mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {benefits.map((benefit, idx) => (
              <div
                key={idx}
                className={`relative rounded-2xl bg-white/[0.03] hover:bg-white/[0.05] border border-white/10 backdrop-blur-sm p-7 transition-all hover:-translate-y-1${idx === 4 ? ' sm:col-span-2 lg:col-span-1 sm:max-w-md sm:mx-auto lg:max-w-none' : ''}`}
              >
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-500/20 to-blue-600/20 border border-cyan-400/20 flex items-center justify-center mb-5 text-cyan-300">
                  {benefit.icon}
                </div>
                <h3 className="font-black text-white mb-2 text-lg leading-tight">{benefit.title}</h3>
      ...
      <section id="modelle" className="relative py-20 md:py-28 scroll-mt-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <p className="text-[10px] sm:text-xs font-black text-emerald-300 uppercase tracking-[0.3em] mb-4">
              ...
              return (
                ...
                >
                  <div className="rounded-[calc(1.5rem-1.5px)] bg-gradient-to-br from-[#13203a] to-[#0d1a2e] p-7 md:p-8 h-full flex flex-col">
                    <h3 className="text-xl font-black text-white mb-1 leading-tight">{model.title}</h3>
                    <p className={`text-sm font-bold mb-4 ${isHl ? 'text-cyan-300' : 'text-white/40'}`}>
                      {model.subtitle}
                    </p>
                    <p className="text-white/60 text-sm leading-relaxed mb-6">{model.description}</p>
                    <ul className="space-y-2.5 mt-auto">
                      {model.highlights.map((h, i) => (
                        <li key={i} className="flex items-start gap-2.5">
                          <svg className="w-4 h-4 text-cyan-300 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {steps.map((s) => (
              <div
                key={s.step}
                className="relative rounded-2xl bg-white/[0.03] hover:bg-white/[0.05] border border-white/10 backdrop-blur-sm p-6 transition-all"
              >
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-500/20 to-blue-600/20 border border-cyan-400/20 flex items-center justify-center mb-4">
                  <span className="text-cyan-300 font-black text-sm tracking-wide">{s.step}</span>
                </div>
                <h3 className="font-black text-white mb-2 leading-tight">{s.title}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
            ...
            <div className="flex flex-col">
              ...
              <a
                ...
                className="group relative rounded-2xl bg-white/[0.03] hover:bg-white/[0.06] border border-white/10 hover:border-white/20 backdrop-blur-sm p-7 mb-6 transition-all"
              >
                ...
                <p className="text-white font-black text-lg mb-1.5">MG Gebäudeservice</p>
                <p className="text-white/55 text-sm leading-relaxed">{t('partner.partners.mgDesc')}</p>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group relative rounded-2xl bg-white/[0.03] hover:bg-white/[0.06] border border-white/10 hover:border-white/20 backdrop-blur-sm p-7 mb-8 transition-all"
              >
                <div className="bg-white/95 rounded-xl px-4 py-3 inline-flex items-center mb-4">
                  <Image
                ...
                <p className="text-white font-black text-lg mb-3">PAVAN GmbH</p>
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 bg-white text-gray-900 font-bold px-7 py-3.5 rounded-full text-sm max-w-fit hover:bg-white/90 transition-colors"
              >
      ...
      <section id="kontakt" className="relative py-20 md:py-28 scroll-mt-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {status === 'success' ? (
            <div className="relative rounded-3xl bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 border border-emerald-400/30 p-10 text-center">
              ...
              <h3 className="text-2xl font-black text-white mb-2">{t('partner.contact.success.title')}</h3>
              <p className="text-white/60">{t('partner.contact.success.desc')}</p>
            </div>
          ) : (
            <div className="relative rounded-3xl bg-gradient-to-br from-[#13203a] via-[#0d1a2e] to-[#13203a] border border-white/10 p-7 md:p-10 overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="relative space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label htmlFor="name" className="block text-xs font-black uppercase tracking-wider text-white/60 mb-2">{t('partner.contact.name')}</label>
                    <input
                      id="name"
                      type="text"
                      required
                  ...
                  <div>
                    <label htmlFor="company" className="block text-xs font-black uppercase tracking-wider text-white/60 mb-2">{t('partner.contact.company')}</label>
                    <input
                      id="company"
                      type="text"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label htmlFor="email" className="block text-xs font-black uppercase tracking-wider text-white/60 mb-2">{t('partner.contact.email')}</label>
                    <input
                      id="email"
                      type="email"
                      required
                  ...
                  <div>
                    <label htmlFor="phone" className="block text-xs font-black uppercase tracking-wider text-white/60 mb-2">{t('partner.contact.phone')}</label>
                    <input
                      id="phone"
                      type="tel"
                      required
                ...
                <div>
                  <label htmlFor="partnerType" className="block text-xs font-black uppercase tracking-wider text-white/60 mb-2">{t('partner.contact.model')}</label>
                  <select
                    id="partnerType"
                    value={formData.partnerType}
                    onChange={(e) => setFormData({ ...formData, partnerType: e.target.value })}
                    className={`${inputCls} bg-[#0d1a2e] appearance-none`}
                  >
                    <option value="" className="bg-[#0d1a2e]">{t('partner.contact.model.placeholder')}</option>
                    <option value="Empfehlungspartner" className="bg-[#0d1a2e]">{t('partner.contact.model.empfehlung')}</option>
                    <option value="Integrationspartner" className="bg-[#0d1a2e]">{t('partner.contact.model.integration')}</option>
                    <option value="Vertriebspartner" className="bg-[#0d1a2e]">{t('partner.contact.model.vertrieb')}</option>
                    <option value="Noch unsicher" className="bg-[#0d1a2e]">{t('partner.contact.model.unsicher')}</option>
                  </select>
                </div>
                <div>
                  <label htmlFor="message" className="block text-xs font-black uppercase tracking-wider text-white/60 mb-2">{t('partner.contact.message')}</label>
                  <textarea
                    id="message"
                    rows={4}
                ...
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-3 bg-white hover:bg-white/90 disabled:bg-white/40 text-gray-900 font-black px-8 py-4 rounded-full transition-all text-base"
                >
                  {status === 'sending' ? (
                    <>
                ...
                <p className="text-center text-white/50 text-sm pt-2">
                  ...
                  <a href="mailto:fynn@taskeyapp.com" className="text-cyan-300 hover:text-cyan-200 font-medium">
                    fynn@taskeyapp.com
                  </a>
                </p>
              </form>
