...
const UI: Record<Locale, {
  ...
  de: {
    ...
    ctaBody: "Legen Sie in wenigen Minuten Ihren kostenlosen Account an – keine Kreditkarte, jederzeit kündbar.",
  ...
  en: {
    ...
    ctaBody: "Create your free Taskey account in minutes – no credit card, cancel anytime.",
  ...
  fr: {
    ...
    ctaBody: "Créez votre compte Taskey gratuit en quelques minutes – sans carte de crédit, résiliable à tout moment.",
    ctaButton: "Commencer",
    homeCrumb: "Accueil",
  },
};
