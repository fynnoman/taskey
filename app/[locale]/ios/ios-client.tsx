        ...
        <div className="max-w-6xl mx-auto px-5 lg:px-8">
          ...
          <div className="lg:hidden text-center">
            <div className="inline-flex items-center gap-2 bg-slate-100 rounded-full px-4 py-1.5 mb-5">
              ...
              <span className="text-xs font-bold text-slate-700">{t("iosPage.badge")}</span>
            </div>
            ...
            <p className="text-base text-slate-500 mb-8 px-2">
            ...
            <div className="flex flex-col gap-3 px-2">
              ...
              <Link
                href="/features"
                className="flex items-center justify-center px-6 py-3.5 text-slate-900 border-2 border-slate-200 text-base font-bold rounded-xl"
              >
          ...
          <div className="hidden lg:flex items-center gap-16">
            ...
            <div className="flex-1 text-left">
              <div className="inline-flex items-center gap-2 bg-slate-100 rounded-full px-4 py-1.5 mb-6">
                ...
                <span className="text-sm font-bold text-slate-700">{t("iosPage.badge")}</span>
              </div>
              ...
              <div className="flex flex-row gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-white text-slate-900 text-lg font-bold rounded-2xl hover:bg-slate-50 transition-colors shadow-lg"
                >
                ...
                <Link
                  href="/features"
                  className="inline-flex items-center justify-center px-8 py-4 text-slate-900 border-2 border-slate-200 text-lg font-bold rounded-2xl hover:border-slate-400 hover:bg-slate-50 transition-colors"
                >
                  {t("iosPage.allFeatures")}
                </Link>
              </div>
                  ...
                  <div className="text-center px-6 mt-6">
                    ...
                    <div className="space-y-2.5">
                      <div className="bg-blue-100 backdrop-blur rounded-xl p-3 text-left">
                        <p className="text-slate-600 text-[10px] uppercase tracking-wider">{t("iosPage.mockup.orders")}</p>
                        <p className="text-slate-900 text-xl font-black">12</p>
                      </div>
                      <div className="bg-blue-100 backdrop-blur rounded-xl p-3 text-left">
                        <p className="text-slate-600 text-[10px] uppercase tracking-wider">{t("iosPage.mockup.teamOnline")}</p>
                        <p className="text-slate-900 text-xl font-black">8/10</p>
                      </div>
                      <div className="bg-blue-100 backdrop-blur rounded-xl p-3 text-left">
                        <p className="text-slate-600 text-[10px] uppercase tracking-wider">{t("iosPage.mockup.hours")}</p>
      ...
      <section className="py-12 lg:py-24 bg-slate-50">
        <div className="max-w-6xl mx-auto px-5 lg:px-8">
          ...
          <div className="hidden lg:grid grid-cols-2 gap-6">
            <div className="bg-white rounded-3xl p-8 border border-slate-100 hover:border-blue-200 transition-colors hover:shadow-lg group">
              ...
              <p className="text-base text-slate-500 leading-relaxed">{t("iosPage.feature1.desc")}</p>
            </div>
            <div className="bg-white rounded-3xl p-8 border border-slate-100 hover:border-blue-200 transition-colors hover:shadow-lg group">
              <div className="w-14 h-14 bg-blue-900 rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
                <svg className="w-7 h-7 text-slate-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-base text-slate-500 leading-relaxed">{t("iosPage.feature2.desc")}</p>
            </div>
            <div className="bg-white rounded-3xl p-8 border border-slate-100 hover:border-blue-200 transition-colors hover:shadow-lg group">
              <div className="w-14 h-14 bg-blue-900 rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
                <svg className="w-7 h-7 text-slate-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-base text-slate-500 leading-relaxed">{t("iosPage.feature3.desc")}</p>
            </div>
            <div className="bg-white rounded-3xl p-8 border border-slate-100 hover:border-blue-200 transition-colors hover:shadow-lg group">
              <div className="w-14 h-14 bg-blue-900 rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
                <svg className="w-7 h-7 text-slate-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-base text-slate-500 leading-relaxed">{t("iosPage.feature4.desc")}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 lg:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-5 lg:px-8">
          ...
          <div className="bg-white rounded-xl lg:rounded-3xl p-6 lg:p-12 text-center">
            ...
            <p className="text-sm lg:text-lg text-slate-500 mb-6 lg:mb-8 max-w-xl mx-auto">
