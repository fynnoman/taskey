    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-sm text-slate-500 mt-3">Schulz &amp; Stosse GbR · Stand: März 2026</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          ...
          >
            ...
            <h2 className="text-xl font-bold text-slate-900 mb-3">Nutzungsbedingungen &amp; AGB</h2>
          ...
          <div className="relative bg-white rounded-2xl border-2 border-slate-200 p-8">
            ...
            <h2 className="text-xl font-bold text-slate-900 mb-3">AGB &amp; SLA für Unternehmen</h2>
            <p className="text-sm text-slate-600 leading-relaxed mb-6">
            ...
            <div className="space-y-3">
              ...
              >
                <div>
                  <span className="text-sm font-bold text-slate-900 group-hover/link:text-slate-900 transition-colors">AGB (B2B)</span>
                  <span className="block text-xs text-slate-500 group-hover/link:text-slate-500 transition-colors">Allgemeine Geschäftsbedingungen</span>
                </div>
              ...
              >
                <div>
                  <span className="text-sm font-bold text-slate-900 group-hover/link:text-slate-900 transition-colors">SLA</span>
                  <span className="block text-xs text-slate-500 group-hover/link:text-blue-200 transition-colors">Service Level Agreement &amp; Verfügbarkeit</span>
                </div>
                <svg className="w-4 h-4 text-slate-500 group-hover/link:text-slate-900 transition-colors flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
              </a>
            </div>
          ...
          >
            ...
            <h2 className="text-xl font-bold text-slate-900 mb-3">AGB für Mitarbeiter</h2>
            <p className="text-sm text-slate-600 leading-relaxed mb-6">
        ...
        <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200">
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-sm text-slate-700 font-semibold mb-1">Schulz &amp; Stosse GbR</p>
              <p className="text-sm text-slate-600">In der Acht 44, 66333 Völklingen, Deutschland</p>
              <p className="text-sm text-slate-500 mt-2">Bei Fragen zu unseren Geschäftsbedingungen erreichen Sie uns unter <a href="mailto:fynn@taskeyapp.com" className="text-blue-700 hover:underline font-medium">fynn@taskeyapp.com</a></p>
            </div>
          </div>
        </div>
