...
const CONTENT = {
  de: {
    ...
    CTA_BODY: "Erstellen Sie kostenlos Ihren Taskey-Account. Kein Setup-Aufwand, keine Vertragsbindung, voller Funktionsumfang.",
  ...
  en: {
    ...
    CTA_BODY: "Create your free Taskey account. No setup effort, no contract lock-in, full feature set.",
  ...
  fr: {
    ...
    CTA_BODY: "Créez votre compte Taskey gratuit. Sans frais de mise en place, sans engagement, fonctionnalités complètes.",
