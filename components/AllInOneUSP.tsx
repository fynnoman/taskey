...
const CONTENT = {
  de: {
    slides: [
      ...
      {
        label: "Kundendashboard",
        title: "Das Dashboard für Ihren Auftraggeber",
        subtitle: "Live-Status, Fotos, Protokolle und Budget – alles im Auftraggeber-Portal.",
        tag: "Kundendashboard",
  ...
  en: {
    slides: [
      ...
      },
      {
        ...
        title: "The dashboard for your clients",
        subtitle: "Live status, photos, reports and budget — all in the client portal.",
  ...
  fr: {
    slides: [
      ...
      },
      {
        ...
        title: "Le tableau de bord pour vos clients",
        subtitle: "Statut en direct, photos, comptes-rendus et budget — tout dans le portail client.",
